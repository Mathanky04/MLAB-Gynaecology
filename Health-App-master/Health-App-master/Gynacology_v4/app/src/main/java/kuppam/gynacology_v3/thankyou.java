...
public class thankyou extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String name = user.get(doctor_account.KEY_NAME);
        Toast.makeText(getApplicationContext(), "User Logged in: " + name, Toast.LENGTH_LONG).show();
    ...
    public void syncSQLiteMySQLDB(){
        ...
        if(patientList.size()!=0){
            ...
            if(dbSyncCount() != 0){
                ...
                client.post("http://192.168.43.13/gyno/insertuser.php",params ,new AsyncHttpResponseHandler() {
